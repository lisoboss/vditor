...
function EcodeCreate() {
    ...
    ecode.trans = function (ele) { //ele如果为空则转换当前所有class为ecode的，ele为指定的即转换指定，同时ele可以为自定义的元素数组
        ...
        lastPart = -1;
        // if (eleEcode.getAttribute("status") != "trans") {
        // eleEcode.setAttribute("status", "trans");
        var origiData = eleEcode.innerHTML;
        origiData = origiData.replace(/</g, "&lt;");
        origiData = origiData.replace(/>/g, "&gt;");
        // eleEcode.innerHTML = "<p>Loading...</p>"
        ...
        // console.log(eleEcode.clientHeight + "px h问0")
        // console.log(eleEcode.clientWidth + "px w问0")

        var allHTML = "<div class='show'>" + html + "</div>";

        eleEcode.innerHTML = allHTML;
        // console.log(eleEcode.clientHeight + "px h问1")
        // console.log(eleEcode.clientWidth + "px w问1")




        // console.log(eleEcode.clientHeight + "px h问2")
        // console.log(eleEcode.clientWidth + "px w问2")

        eleEcode.style.width = eleEcode.clientWidth - 50 + "px";

        // console.log(eleEcode.clientHeight + "px 3847hhhhh")

        eleEcode.style.height = eleEcode.clientHeight + "px";

        // console.log(eleEcode.clientHeight + "px 3847h")

        var eleEcodeIfTrue = eleEcode.querySelectorAll(".ifTrue");
        var eleEcodeCyc = eleEcode.querySelectorAll(".cycle");
        var eleEcodeShow = eleEcode.querySelector(".show");
        var eleEcodeJudge = eleEcode.querySelectorAll(".judge");
        var eleEcodeIf = eleEcode.querySelectorAll(".if");
        var eleEcodeUl = eleEcode.querySelectorAll("ul");
        // console.log(eleEcode.clientWidth)
        // console.log(eleEcode.clientWidth - 35 + "px 111")
        eleEcodeShow.style.width = eleEcode.clientWidth + "px";
        ...
        for (var b = 0; b < eleEcodeIf.length; b++) {
            ...
            // console.log("parent 1 ", parent.children[def].offsetTop - add)
        ...
        for (var b = 0; b < ifTrueValueFixed.length; b++) {
            ...
            if (turn1) {
                ...
                // console.log(parent.clientHeight + "px 222333")
                // console.log(parent)
        ...
        eleEcodeShow.style.height = '';
        eleEcode.style.height = '';
        eleEcode.style.width = '';
        eleEcode.style["max-height"] = '';
        eleEcode.classList.remove("vditor-linenumber")
    }
    function isArray(o) {
...
function Ecode(ele) {
    EcodeCreate().trans(ele)
    return ele.getElementsByClassName("show")[0]
}
